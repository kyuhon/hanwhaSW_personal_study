...
public class MenuController {
    ...
    public void findAllMenus() {
        List<com.ohgiraffers.section01.xmlconfig.MenuDTO> menuList = menuService.findAllMenus();
    ...
    public void findMenuByMenuCode(Map<String, String> parameter) {
        ...
        com.ohgiraffers.section01.xmlconfig.MenuDTO menu = menuService.findMenuByMenuCode(menuCode);
    ...
    public void registMenu(Map<String, String> parameter) {
        ...
        com.ohgiraffers.section01.xmlconfig.MenuDTO menu = new com.ohgiraffers.section01.xmlconfig.MenuDTO();
    ...
    public void modifyMenu(Map<String, String> parameter) {
        ...
        com.ohgiraffers.section01.xmlconfig.MenuDTO menu = new MenuDTO();
