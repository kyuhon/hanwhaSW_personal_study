...
public class UserServiceImpl implements UserService {
    ...
    public void registUser(UserDTO userDTO) {
        ...
        /* 설명. UserDTO로 넘어온 사용자의 암호(평문)을 BCrypt 암호화 해서(다이제스트)
        *   UserEntity에 전달 */
    ...
    /* 설명. spring security 사용 시 프로바이더 활용 할 로그인용 메소드(UserDetails 타입을 반환하는 메소드) */
    @Override
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {

        /* 설명. 넘어온 email과 일치하는 email을 가진 회원을 조회해서 UserEntity로 변환(조회)받음 */
