...
INSERT INTO auth_list (id, auth, description) VALUES
                                                  (1, 'ROLE_ADMIN',            '관리자 권한'),
                                                  (2, 'ROLE_CUSTOMER_MANAGER', '고객관리 팀장 권한'),
                                                  (3, 'ROLE_SALES_MANAGER',    '영업관리 팀장 권한'),
                                                  (4, 'ROLE_PRODUCT_MANAGER',  '제품관리 팀장 권한'),
                                                  (5, 'ROLE_MEMBER',           '팀원 권한');

-- 1-4. 직책 (emp_position)
INSERT INTO emp_position (id, position_name, description) VALUES
                                                              (1, '관리자',        '전사 운영 및 최종 의사 결정'),
...
-- 2-3. 제품 (item)
INSERT INTO item
(id, name, serial_num, monthly_price, status, start_date, last_inspect_date, sales, repair_cost, category_id)
VALUES
    (1, '업무용 미니 PC', 'PC-0001', 150000, 'A', '2024-01-01 00:00:00', '2025-01-01 00:00:00', 45, 10000, 1),
    (2, '고성능 워크스테이션', 'PC-0002', 280000, 'A', '2024-02-01 00:00:00', '2025-01-10 00:00:00', 18, 20000, 1),
    (3, '회의실 4K 디스플레이', 'MEET-0001', 350000, 'A', '2023-06-01 00:00:00', '2024-12-01 00:00:00', 22, 0, 2),
    (4, '원격 화상회의 올인원 패키지', 'MEET-0002', 550000, 'A', '2023-08-01 00:00:00', '2025-01-05 00:00:00', 15, 80000, 2),
    (5, '전동 높이조절 데스크', 'FURN-0001', 90000, 'A', '2023-05-01 00:00:00', '2024-11-01 00:00:00', 52, 0, 3),
    (6, '인체공학 메쉬 의자', 'FURN-0002', 65000, 'A', '2023-09-01 00:00:00', '2024-12-15 00:00:00', 40, 15000, 3),
    (7, '고속 문서 스캐너', 'OFF-0001', 70000, 'A', '2024-03-01 00:00:00', '2025-01-18 00:00:00', 12, 5000, 4),
    (8, '네트워크 복합기', 'OFF-0002', 160000, 'A', '2024-05-01 00:00:00', '2025-01-20 00:00:00', 16, 0, 4),
    (9, 'VPN 보안 게이트웨이', 'NET-0001', 210000, 'A', '2023-11-01 00:00:00', '2025-01-11 00:00:00', 9, 0, 5),
    (10, 'L3 네트워크 스위치', 'NET-0002', 260000, 'A', '2024-07-01 00:00:00', '2025-01-02 00:00:00', 6, 0, 5);
...
(id, name, start_date, contract_period, status, monthly_payment, total_amount, pay_method, pay_date, special_content, cum_id)
VALUES
-- 진행중
(1,  '글로벌텍 회의실 장비 렌탈',       '2024-05-01 00:00:00', 12, 'P', 1200000, 14400000,  'C', '매월 10일', '파일럿 성격',           1),
(2,  '스마트오피스 오피스 풀패키지',    '2025-10-25 00:00:00', 24, 'P', 3000000, 72000000,  'B', '매월 15일', '신규 고객 할인 10%',    2),
(3,  '비즈니스파트너스 장기 계약',      '2024-05-01 00:00:00', 36, 'P', 1800000, 64800000,  'C', '매월 말일', '데스크·의자 포함',     3),
(4,  '테크노베이션 서버·네트워크 계약', '2023-03-01 00:00:00', 36, 'P', 2500000, 90000000,  'B', '매월 5일',  '만료 2개월 전 재협상', 4),
(5,  '미래산업 VIP 패키지',             '2020-09-01 00:00:00', 60, 'P', 3500000, 210000000, 'C', '매월 20일', 'VIP 특별 조건',        5),
-- 만료됨
(6,  '스타트업코리아 테스트 계약',       '2021-09-01 00:00:00', 24, 'C', 1000000, 24000000,  'C', '매월 10일', '연체·분쟁 발생',       6),
(7,  '비즈카페 장비 증설 계약',         '2024-08-01 00:00:00', 24, 'C', 1600000, 38400000,  'B', '매월 12일', '향후 업셀 대상',       7),
(8,  '테크솔루션 기술지원 패키지',       '2021-03-01 00:00:00', 48, 'C', 2200000, 105600000,'B', '매월 18일', 'AS SLA 포함',         8),
(9,  '한울시스템 데이터센터 계약',       '2022-11-01 00:00:00', 36, 'C', 2100000, 75600000,  'C', '매월 7일',  '재계약 협의 중',       9),
(10, '테라네트웍스 네트워크 패키지',     '2025-08-01 00:00:00', 12, 'C', 1400000, 16800000,  'B', '매월 9일',  '신규·확장 혼합',       10);

-- 2-8. 견적/상담 기록 (quote)
INSERT INTO quote
(id, status, counseling_date, counselor, summary, content, channel_id, cum_id)
VALUES
    (1, 'A', '2025-01-10 10:00:00', 'rental006', '업무용 PC 50대 견적',       '글로벌텍 PC 패키지 견적',              1, 1),
    (2, 'A', '2025-01-15 11:00:00', 'rental006', '오피스 풀패키지 제안',     '스마트오피스 풀패키지 신규 제안',      2, 2),
    (3, 'A', '2025-01-20 15:00:00', 'rental002', '회의실+가구 패키지',       '비즈니스파트너스 회의실 패키지 제안',  3, 3),
    (4, 'P', '2025-01-22 09:30:00', 'rental002', '서버·네트워크 업그레이드', '테크노베이션 업그레이드 제안',         3, 4),
    (5, 'C', '2025-01-25 14:00:00', 'rental007', 'VIP 패키지 리뉴얼',        '미래산업 VIP 조건 재협상',             2, 5),
    (6, 'C', '2025-01-27 13:00:00', 'rental007', '테스트 계약 제안',         '스타트업코리아 테스트 장비 제안',       4, 6),
    (7, 'A', '2025-01-28 10:00:00', 'rental006', '카페 장비 증설',           '비즈카페 장비 증설 견적',              5, 7),
    (8, 'A', '2025-01-29 11:30:00', 'rental002', '기술지원 패키지',          '테크솔루션 기술지원 패키지 제안',       2, 8),
    (9, 'P', '2025-01-30 15:00:00', 'rental007', '데이터센터 증설',          '한울시스템 데이터센터 증설 견적',       1, 9),
    (10,'A', '2025-01-31 09:00:00', 'rental006', '네트워크 패키지',          '테라네트웍스 네트워크 패키지 제안',     3, 10);
...
INSERT INTO emp_position_auth (id, position_id, auth_id) VALUES
                                                             (1, 1, 1),  -- 관리자 -> ROLE_ADMIN
                                                             (2, 2, 2),  -- 고객관리 팀장 -> ROLE_CUSTOMER_MANAGER
                                                             (3, 3, 3),  -- 영업관리 팀장  -> ROLE_SALES_MANAGER
                                                             (4, 4, 4),  -- 제품관리 팀장  -> ROLE_PRODUCT_MANAGER
                                                             (5, 5, 5);  -- 팀원          -> ROLE_MEMBER

-- 3-2. 사원별 권한 (employee_auth)
INSERT INTO employee_auth (id, auth_id, emp_id) VALUES
                                                    (1, 1, 1),  -- admin -> ADMIN
                                                    (2, 2, 2),  -- rental001 -> CUSTOMER_MANAGER
                                                    (3, 3, 3),  -- rental002 -> SALES_MANAGER
                                                    (4, 4, 4),  -- rental003 -> PRODUCT_MANAGER
                                                    (5, 5, 5),
                                                    (6, 5, 6),
                                                    (7, 5, 7),
                                                    (8, 5, 8),
